...
const mockProjects = [
  {
    ...
    demoLink: 'https://my-sadhana-tracker-frontend.web.app/',
    githubLink: 'https://github.com/Anmol272001/sadhna-tracker'
  },
  {
    id: 2,
    ...
    demoLink: 'https://task-manager-phi-topaz.vercel.app/',
    githubLink: 'https://github.com/Anmol272001/Task-Manager'
  },
  {
    id: 3,
      ...
      <div className="p-6">
        ...
        <div className="flex gap-3 mt-4">
          <a
            ...
            className="inline-block bg-blue-600 text-white font-medium px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition duration-300"
          >
            View Demo
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gray-800 text-white font-medium px-4 py-2 rounded-full text-sm hover:bg-gray-900 transition duration-300"
          >
            View Code
          </a>
        </div>
